"""
GitLab repository collaborators reader.

Retrieves the list of collaborators in a GitLab repository and converts them to documents.
...
class GitLabRepositoryCollaboratorsReader(BaseReader):
    """
    GitLab repository collaborators reader.

    Retrieves the list of collaborators of a GitLab repository and returns a list of documents.

    Examples:
        >>> reader = GitLabRepositoryCollaboratorsReader("owner", "repo")
    ...
    def __init__(
        self,
        gitlab_client: BaseGitLabCollaboratorsClient,
        owner: str,
        repo: str,
        verbose: bool = False,
    ):
        ...
        Args:
            - gitlab_client (BaseGitLabCollaboratorsClient): GitLab client.
    ...
    def load_data(
        ...
        while True:
            collaborators: Dict = self._loop.run_until_complete(
                self._gitlab_client.get_collaborators(
...
if __name__ == "__main__":
    ...
    gitlab_client = GitLabCollaboratorsClient(verbose=True)

    reader = GitLabRepositoryCollaboratorsReader(
