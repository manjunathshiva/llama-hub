"""
GitLab API client for collaborators
"""
...
class BaseGitLabCollaboratorsClient(Protocol):
...
class GitLabCollaboratorsClient:
    """
    An asynchronous client for interacting with the GitLab API for collaborators.
    ...
    Examples:
        >>> client = GitLabCollaboratorsClient("my_gitlab_token")
    ...
    def __init__(
        ...
        """
        Initialize the GitLabCollaboratorsClient.
    ...
    async def get_collaborators(
        ...
        Returns:
            - See https://docs.gitlab.com/en/rest/collaborators/collaborators?apiVersion=2022-11-28#list-repository-collaborators
...
if __name__ == "__main__":
    ...
    async def main() -> None:
        """Test the GitLabCollaboratorsClient."""
        client = GitLabCollaboratorsClient()
